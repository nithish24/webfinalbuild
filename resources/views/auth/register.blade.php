            ...
            <form method="POST" action="{{ route('register') }}" id="register-form">
                @csrf
                    <div class="form-group row">
                        <input id="name" type="text" class="fadeIn second @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="What is your name?">
                          <br/>
                            @error('name')
                    ...
                    <div class="form-group row">
                        <input id="usn" type="text" class="fadeIn fourth @error('usn') is-invalid @enderror" name="usn" value="{{ old('usn') }}" required autocomplete="usn" placeholder="Your USN?">
                                <br/>
                                @error('usn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
